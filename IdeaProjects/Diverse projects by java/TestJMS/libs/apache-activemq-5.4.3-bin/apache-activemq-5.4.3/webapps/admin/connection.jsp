	...
	<td>
		<c:choose>
			<c:when test="${consumer.destinationQueue}">
				Queue <a href="browse.jsp?JMSDestination=${ru.jms.project.simpleExampleJMS.consumer.destinationName}"><c:out value="${consumer.destinationName}" /></a>
			</c:when>
			<c:when test="${consumer.destinationTopic}">
				Topic <a href="send.jsp?JMSDestination=${ru.jms.project.simpleExampleJMS.consumer.destinationName}"><c:out value="${consumer.destinationName}" /></a>
			</c:when>
			<c:otherwise>
