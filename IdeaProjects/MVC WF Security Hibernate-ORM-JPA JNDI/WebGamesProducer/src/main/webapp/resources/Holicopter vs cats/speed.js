...
var myLeftBtn;
var myRightBtn;
var massObstacles = [new Obstacle(485, 120, 40, 200, "/resources/Holicopter vs cats/imgs/cat_1.png"), new Obstacle(485, -120, 40, 200, "/resources/Holicopter vs cats/imgs/cat_2.png")];
var score;
...
function Obstacle(x, y, width, height, imgSrc) {
	this.x = x;
	this.y = y;
	this.width = width;
	this.height = height;
	...
	this.createNewObtacle = function() {
		...
		if(massObstacles[massObstacles.length - 1].x < 150) {
			...
			var item_1 = new Obstacle(485, randY_1, 40, 270, "/resources/Holicopter vs cats/imgs/cat_2.png");
			var item_2 = new Obstacle(485, randY_2, 40, 270, "/resources/Holicopter vs cats/imgs/cat_1.png");
...
function startGame(){
	myGameArea.start();
	myGamePiece = new component(30, 20, "/resources/Holicopter vs cats/imgs/hole_1.png", 10, 120, "image");
	myBackground = [new component(480, 270, "/resources/Holicopter vs cats/imgs/background1.png", 0, 0, "background"), new component(480, 270, "/resources/Holicopter vs cats/imgs/background2.png", 480, 0, "background")];
...
var myGameArea ={
	...
	start: function(){
		...
		window.addEventListener("mousedown", function(e){
			myGamePiece.img.src = "/resources/Holicopter vs cats/imgs/hole_2.png";
			myGameArea.x = e.pageX;
			myGameArea.y = e.pageY;
		});
		window.addEventListener("mouseup", function(e){
			myGamePiece.img.src = "/resources/Holicopter vs cats/imgs/hole_1.png";
			myGameArea.x = false;
			myGameArea.y = false;
		});
