...
//    public QuizThread(DatagramSocket socket, List<DatagramPacket> requestsPackets, List<String> requestMessages)
//    {
//        this.socket = socket;
//        this.requestsPackets = requestsPackets;
//        this.requestMessages = requestMessages;
//    }

    public QuizThread(DatagramPacket request, List<Question> quiz, DatagramSocket socket)
    {
